...
__all__ = [
    ...
    "verify_inference_record",
    "validate_record_hash_format",
    # Phase 10.9 Replay & Consistency Verification
    "ReplayEligibilityStatus",
    "ReplayMode",
    "ReplayConsistencyStatus",
    "ComparisonStatus",
    ...
    "ReplayTimeoutError",
    "ReplayVersionUnsupportedError",
    # Phase 10.10 Evidence & Provenance Binding
    "InferenceEvidenceType",
    "InferenceFindingType",
    "InferenceEvidenceStatus",
    "InferenceEvidence",
